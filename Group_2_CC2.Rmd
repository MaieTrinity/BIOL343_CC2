...
positpal::start("Group_2_CC2.Rmd")
```
...
1. **Maie Trinity Wyshynski** - 20394829 
    + [BIOL343_CC](https://github.com/MaieTrinity/BIOL343_CC2)

2. **Dev Patel** - 20452825
    + [BIOL343_CC](https://github.com/DevPatelZz/BIOL343_CC)

3. **Darcy Talbot** - 20464912 
    + [BIOL343_CC](https://github.com/darcytalbot/biol343_cc2)

4. **Elijah Dipchand** - 20332206
    + [BIOL343_CC](https://github.com/Elijah-Dipchard_Repository/BIOL343_CC)
...
---------|-------------|------
population_type | sexual or asexual | Categorical (A or S)
ovary_width | width of the ovary | mm
ovary_height | height of the ovary | mm
flower_number | the number of flowers? | numerical
...
```{r import-clean}
cc1_data <- transform(read.csv("A1_Data_Excel.csv")[1:46,1:8], ovary_area = ovary_width*ovary_height)
...
```{r area-table, include=T, echo=F}
library('knitr')
kable(area_means, caption = "Summary Table of Mean Ovary Area by Population Type")
```
...
```{r area-histogram, include=T, echo=F}
library(ggplot2)
cc1_data <- cc1_data[!is.na(cc1_data$population_type),]
...
![Hydroponic Photo](./images/Hydroponic_g13.jpg)
